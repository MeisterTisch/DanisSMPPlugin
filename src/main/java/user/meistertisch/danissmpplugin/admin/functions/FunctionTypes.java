...
public enum FunctionTypes {
    ...
    SLIME_CHUNK_CHECK_SYSTEM("functionTypes.slime_chunk_check_system", "functionTypes.slime_chunk_check_system.desc", "slimeChunkCheck.use", Material.SLIME_BALL),
    SCCS_SAVE_CHUNKS("functionTypes.sccs_save_chunks", "functionTypes.sccs_save_chunks.desc", "slimeChunkCheck.save", Material.WRITABLE_BOOK),
    SCCS_ONLY_CENTER("functionTypes.sccs_only_center", "functionTypes.sccs_only_center.desc", "slimeChunkCheck.onlyCenter", Material.LINGERING_POTION),
